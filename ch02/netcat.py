...
class NetCat:
    ...
    def listen(self):
        ...
        while True:
            ...
            client_thread.start()
            print(f'[*] Accepted connection from {_[0]}:{_[1]}')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
            description='This is used to send and receive tcp packets',
            ...
            epilog=textwrap.dedent('''Example:
                ...
                echo 'ABC' | ./netcat.py -t 192.168.1.108 -p 135 # echo text to a server port 135
